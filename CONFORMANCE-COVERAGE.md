...
| AEON-to-portable-AES projection | experimental | `cts/aes/v1/aes-cts.v1.next.json`, `cts/aes/v1/suites/01-baseline.json` through `cts/aes/v1/suites/05-next-limit-semantics.json` | mutable 67-vector source-projection target covering values, indexed order, flat attributes, references, node expansion, and all four structural-identity locations; passes in TypeScript, Rust, Python, and PHP | AEON implementation AES projection suites |
